...
new Cocktail('Margarita', 'https://www.wikihow.com/images/thumb/3/3f/Make-a-Habanero-Margarita-Step-11---Version-2.jpg/aid214058-v4-1200px-Make-a-Habanero-Margarita-Step-11---Version-2.jpg', 'La Margarita est un cocktail à base de tequila, inventé par des Américains au Mexique. C\'est un before lunch qui serait une version du cocktail daisy (qui signifie « marguerite » en français, « margarita » en espagnol) dans lequel on remplaça le brandy par de la téquila durant la prohibition, période où les Américains ouvrirent des bars au Mexique et au Canada dans les zones frontalières.', [new Ingredient('limonade', 1), 
  	new Ingredient('citron', 2),
  	new Ingredient('sel', 3)
  	]),


  	new Cocktail('Sour', 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/82/Whiskey_sour.jpg/1024px-Whiskey_sour.jpg', 'Le Whiskey sour est un cocktail alcoolisé à base de whiskey ou de bourbon, de jus de citron, de sucre et optionnellement de blanc d’œuf.', [new Ingredient('perrier', 1), 
